...
function calculateDistanceFromCentralPort(finalCoordinates){

}
var start = Date.now()

for(var index = 0; index<puzzleInput1.length; index++){
    puzzleInput1FinalCoordinates = moveCoordinatesBasedOnInstruction(puzzleInput1[index], puzzleInput1FinalCoordinates);
}

for(var index = 0; index<puzzleInput2.length; index++){
    puzzleInput2FinalCoordinates = moveCoordinatesBasedOnInstruction(puzzleInput2[index], puzzleInput2FinalCoordinates);
}

console.log("puzzleInput1FinalCoordinates", puzzleInput1FinalCoordinates)
console.log("puzzleInput2FinalCoordinates", puzzleInput2FinalCoordinates)
var end = Date.now();
